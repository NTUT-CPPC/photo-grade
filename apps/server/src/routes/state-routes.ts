...
stateRoutes.post("/api/host/state", requireAuth(), async (req, res, next) => {
  try {
...
stateRoutes.post(["/api/sync/idx", "/set_idx"], requireAuth(), async (req, res, next) => {
  try {
...
stateRoutes.post(["/api/sync/mode", "/set_mode"], requireAuth(), async (req, res, next) => {
  try {
